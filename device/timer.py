...
# Show the timer, the TimeInSeconds will be replaced by whatever time we need.
TimeInSeconds = 20 # REPLACE_TIME_HERE
pixels.brightness = .5
pixels.fill(CYAN)
pixels.show()
color_wipe(PURPLE, TimeInSeconds / 30) # Time to "wait" on each one of the 30 leds.

# Show the expired timer alert for a brief moment before stopping
pixels.brightness = .3
TimeInSeconds = 10
